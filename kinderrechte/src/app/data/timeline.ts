...
export const TIMELINE_DATA: TimelineEvent[] = [
  ...
  {
    year: 2024,
    title: '35 Jahre KRK — Neue Herausforderungen',
    summary: 'Digitale Kinderrechte, Klimawandel und die Aufnahme in das Grundgesetz stehen im Fokus.',
    details: 'Im Jahr 2024 stehen neue Themen im Mittelpunkt: Kinderrechte in der digitalen Welt (Datenschutz, Online-Sicherheit), die Auswirkungen des Klimawandels auf Kinder und die seit Jahren diskutierte Aufnahme von Kinderrechten in das deutsche Grundgesetz.',
    color: '#4CAF50'
  }
];
