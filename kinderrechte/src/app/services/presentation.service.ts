...
export class PresentationService {
  ...
  private buildSlides(): PresentationSlide[] {
    ...
    // Transition image slide
    slides.push({ type: 'image', image: 'assets/images/slides/children-school.jpg', title: 'Vermittlung', text: 'Wie werden Kinderrechte in Kita, Schule und Familie vermittelt?', notes: 'Überleitung zum Thema Vermittlung. Bild: Kinder in der Schule.' });

    // Vermittlung an Kinder — compact info
    slides.push({ type: 'info', title: 'Vermittlung an Kinder', accent: '#4CAF50', infoItems: ['Kindergarten (3–6): Bilderbücher, Rollenspiele, Fairness', 'Grundschule (6–10): Projekttage, Klassenräte, Poster', 'Sekundarstufe (10–18): Planspiele, Debatten, Fallstudien'], notes: 'Altersgerechte Vermittlung. UNICEF-Schulen als Best Practice (unicef.de/informieren/einsatz-fuer-kinderrechte/kinderrechteschulen). Makista Modellschul-Netzwerk in Hessen.' });

    // Erzieher*innen — stat slide for key law
    slides.push({ type: 'stat', statValue: '§ 45', statLabel: 'SGB VIII — Betriebserlaubnis', text: 'Seit 2021 müssen Einrichtungen ein Gewaltschutzkonzept vorweisen. Beschwerdemanagement für Kinder ist seit 2012 Pflicht.', color: '#7B1FA2', statSource: '§ 45 Abs. 2 Nr. 3 SGB VIII', notes: '§ 45 SGB VIII als Schlüsselnorm. Reform 2021 stärkt Gewaltschutz. KiTa-Qualitätsgesetz: bmfsfj.bund.de.' });

    // Eltern — image slide with family photo
    slides.push({ type: 'image', image: 'assets/images/slides/family.jpg', title: 'Gewaltfreie Erziehung', text: 'Seit dem Jahr 2000 haben Kinder in Deutschland das Recht auf gewaltfreie Erziehung (§ 1631 Abs. 2 BGB).', notes: 'Gewaltfreie Erziehung seit 2000 gesetzlich verankert. Nummer gegen Kummer: 116 111.' });

    // Schutz in Deutschland — compact info
    slides.push({ type: 'info', title: 'Schutz in Deutschland', accent: '#E91E63', infoItems: ['Jugendamt: Schutzauftrag bei Kindeswohlgefährdung (§ 8a SGB VIII)', 'Grundgesetz: Art. 6 + Art. 2 — Schutz der Familie & freie Entfaltung', 'Nummer gegen Kummer: 116 111 (Kinder) / 0800 111 0550 (Eltern)'], notes: '§ 8a SGB VIII regelt den Schutzauftrag. DeGeDe: degede.de/abc/un-kinderrechtskonvention/.' });

    // Zukunft — compare slide
    slides.push({ type: 'compare', title: 'Zukunft der Kinderrechte', compareLeft: { title: 'Neue Herausforderungen', items: ['Digitale Rechte: Datenschutz, Online-Sicherheit', 'Klimawandel bedroht Gesundheit & Zukunft', 'Grundgesetz-Debatte: Kinderrechte verankern?'], color: '#03A9F4' }, compareRight: { title: 'Positive Entwicklungen', items: ['2026: Jahr der Kinderrechte (Bundesregierung)', 'Kinderrechte-Index 2025 schafft Transparenz', 'Fridays for Future: Kinder als Akteure'], color: '#4CAF50' }, notes: 'Kinderrechte-Index 2025: jugendhilfeportal.de. 2026 als Jahr der Kinderrechte. UNICEF Kinderrechteschulen: 7-stufiges Programm.' });

    // --- VERLETZUNGEN SECTION ---

    // Transition image slide
    slides.push({ type: 'image', image: 'assets/images/slides/child-conflict.jpg', title: 'Verletzungen weltweit', text: '2024 war eines der schlimmsten Jahre für Kinder in Konflikten.', imageCredit: 'Unsplash', notes: '32.990 schwere Verstöße 2024 dokumentiert. Gaza: alle Schulen geschlossen. Sudan: größte Kindervertriebenenkrise.' });

    // Key stats as individual stat slides
    slides.push({ type: 'stat', statValue: '473 Mio.', statLabel: 'Kinder in Konfliktgebieten', text: 'Mehr als jedes sechste Kind weltweit lebt in einer Konfliktzone.', color: '#C0392B', image: 'assets/images/slides/globe-hands.jpg', statSource: 'UNICEF 2024', notes: 'UNICEF State of the World\'s Children 2024.' });

    slides.push({ type: 'stat', statValue: '138 Mio.', statLabel: 'Kinder in Kinderarbeit', text: 'Das UN-Ziel, Kinderarbeit bis 2025 zu beenden, wurde verfehlt. 54 Mio. Kinder arbeiten unter gefährlichen Bedingungen.', color: '#E67E22', statSource: 'ILO/UNICEF 2024', notes: 'ILO Child Labour Report 2024. 160 Mio. (2020) → 138 Mio. (2024).' });

    slides.push({ type: 'stat', statValue: '~4%', statLabel: 'Kindersterblichkeit heute', text: 'Von ~33% im Jahr 1924 auf unter 4% heute. Einer der größten Fortschritte der Menschheitsgeschichte.', color: '#4CAF50', image: 'assets/images/slides/hands-together.jpg', statSource: 'WHO/UNICEF 2024', notes: 'Fortschritte durch Impfungen, Ernährung, medizinische Versorgung. Aber: 113 Jahre bis zur vollen Umsetzung (ChildFund World Index 2024).' });

    // Fortschritte — compare slide
    slides.push({ type: 'compare', title: 'Fortschritte & Rückschläge', compareLeft: { title: 'Fortschritte', items: ['Kindersterblichkeit: 33% → 4%', 'Mangelernährung: 40% → 22%', '196 von 197 Staaten ratifiziert', 'Beschwerderecht seit 2011'], color: '#4CAF50' }, compareRight: { title: 'Rückschläge', items: ['417 Mio. Kinder in Armut', '650 Mio. Frauen als Kind verheiratet', '52 Mio. ohne Schulzugang', '1 Mrd. Kinder vulnerabel'], color: '#C0392B' }, notes: 'Bei aktuellem Tempo noch 113 Jahre bis zur vollen Umsetzung. 4,5 Mio. Kinder könnten bis 2030 durch Kürzungen sterben (The Lancet).' });

    // --- KRITISCHE PERSPEKTIVEN (Lydia) ---

    // Quote slide as opener
    slides.push({ type: 'quote', quoteText: 'Die UN-Kinderrechtskonvention universalisiert westliche Konzepte von Kindheit.', quoteAuthor: 'Imoah, 2012', image: 'assets/images/slides/digital-world.jpg', notes: 'Lydias Forschungsteil beginnt. Einleitung zur kritischen Perspektive.' });

    // Kritische Perspektiven — compact info (kept as list for Lydia's academic content)
    slides.push({ type: 'info', title: 'Kritische Perspektiven', accent: '#795548', infoItems: ['Westlicher Bias: KRK wurzelt in Werten des Global North (Quennerstedt 2018)', 'Kulturrelativismus vs. Universalismus: Debatte seit 1947 (Billaud 2022)', 'Kindheit ist kulturell geprägt — 6 Faktoren (Goodall 2015)', 'Fallstudien: Kinderarbeitsgesetze erhöhten Armut in Südafrika (Levine 2011)'], notes: 'American Anthropological Association nannte 1947 die Menschenrechtserklärung „cultural imperialism". Goodalls 6 Faktoren: Kultur, Gender, Patriarchat, Religion, Universale Aspirationen, Arbeitsmärkte.' });
